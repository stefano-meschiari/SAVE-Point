...
var Templates = Backbone.Model.extend({
    ...
    templates: {
        ...
        "@dashboard": '<button class="btn btn-jrs" id="dashboard-exit" font-l" on' + UI.clickEvent + '="location.href=\'/\';"><span class="fa fa-times"></span> Exit</button>',
        
        "@about": '<button class="btn btn-jrs  font-l" id="gravitykit-about" on' + UI.clickEvent + '="window.open(\'http://save-point.io\');"><span class="fa fa-question"></span> About us</button>',
        "@dark-help": function() {
